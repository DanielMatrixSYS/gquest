...
function panel:CreateChild(data)
    ...
    child.Paint = function(s, w, h)
        ...
        gQuest.DrawTextOutlined(data.Header, "gQuest.16", 7, (h / 2) - 8, gQuest.White, gQuest.Black, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER);
    end
...
function panel:Init()
    ...
    self.Delete.Paint = function(s, w, h)
        ...
        gQuest.DrawTextOutlined(gQuest.L("dbDeleteNPCS"), "gQuest.16", w / 2, 7, gQuest.White, gQuest.Black, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER);
    end
    ...
    self.Delete.DoClick = function()
        ...
        net.Start("gQuest.DeleteQuestNPCS")
...
function panel:Paint(w, h)
    ...
    gQuest.DrawTextOutlined("Main/Delete NPCS", "gQuest.16", 7, 9, gQuest.White, gQuest.Black, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER);
end
vgui.Register("gQuest.QuestMainNPCSDelete", panel, "EditablePanel");