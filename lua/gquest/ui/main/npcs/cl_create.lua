...
function panel:Init()
    ...
    self.PanelData = {
        ...
        {
            name = "Model",
            example = "models/mossman.mdl",
            editable = true,
        },

        {
            name = "Interaction Sound",
            example = "vo/npc/male01/hi01.wav",
            editable = true,
        },
    ...
    self.Create.Paint = function(s, w, h)
        ...
        gQuest.DrawTextOutlined(gQuest.L("uiCreate"), "gQuest.16", w / 2, 7, gQuest.White, gQuest.Black, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER);
    end
...
function panel:Paint(w, h)
    ...
    gQuest.DrawTextOutlined("Main/Quest NPC Editor/Create A New NPC", "gQuest.16", 7, 9, gQuest.White, gQuest.Black, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER);
end
vgui.Register("gQuest.QuestMainNPCSCreate", panel, "EditablePanel");