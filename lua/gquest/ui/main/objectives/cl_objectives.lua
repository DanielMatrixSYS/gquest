...
function panel:Init()
    ...
    self.Buttons = {
        {
            title = gQuest.L("objCreate"),
            ui = "gQuest.QuestMainObjectivesCreate"
        },

        {
            title = gQuest.L("objEdit"),
            ui = "gQuest.QuestMainObjectiveList"
        },

        {
            title = gQuest.L("objDelete"),
            ui = "gQuest.QuestMainObjectivesDelete"
        }
    }
...
gQuest.DrawTextOutlined("Main/Quest Obj Editor", "gQuest.16", 7, 9, gQuest.White, gQuest.Black, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER);
end
vgui.Register("gQuest.QuestMainObjectives", panel, "EditablePanel");