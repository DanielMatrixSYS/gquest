...
AccessorFunc(panel, "Information", "Information", FORCE_STRING);
AccessorFunc(panel, "RealSize", "RealSize", FORCE_NUMBER);
...
function panel:Paint(w, h)
    ...
    local desc = gQuest.textWrap(self.Information, "gQuest.16", self.RealSize - 20);
    gQuest.DrawTextOutlined(desc, "gQuest.16", 7, 37, gQuest.White, gQuest.Black, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER);
end
vgui.Register("gQuest.QuestMainInfo", panel, "EditablePanel");