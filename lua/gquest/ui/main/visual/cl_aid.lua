...
--- CreateChild
---
function panel:CreateChild(name, id)
    ...
    child.DoClick = function(s)
        ...
        gQuest.VisualAid[id] = not gQuest.VisualAid[id];
    end
...
function panel:Init()
    ...
    self:CreateChild(gQuest.L("visualAidPatrol"), "npc_patrol");
    self:CreateChild(gQuest.L("visualAidNPC"), "npc_esp");
...
gQuest.DrawTextOutlined("Main/Developer Tools", "gQuest.16", 7, 9, gQuest.White, gQuest.Black, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER);
end
vgui.Register("gQuest.QuestMainAid", panel, "EditablePanel");